...
<html lang="pt-br">
    ...
    <head>
        ...
        <meta name="author" content="Jorge Reis">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                    ...
                    <div class="sidebar-brand-text mx-3">Area de Administração</div>
                </a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu1 ?>">Motoristas</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu2 ?>">Gerentes de rota</a>

                             <a class="collapse-item" href="index.php?pag=<?php echo $menu3 ?>">Mecanicos</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu4 ?>">Administrativos</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
                        ...
                        <span>Oficina / Garagem</span>
                    </a>
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                           
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu5 ?>">Rotas</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu6 ?>">Oficina</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu5 ?>">Garagem</a>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <img class="mt-2" src="../img/" alt="Logo do sistema" width="150">
